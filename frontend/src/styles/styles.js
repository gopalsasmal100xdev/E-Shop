const styles = {
  ...
  button:
    "w-[150px] bg-black h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300",
  cart_button:
